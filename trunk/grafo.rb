...
class Grafo
  ...
  def initialize(pessoa)
    ...
    #Hash que guarda as informaÁıes moleculares das pessoas para facilitar a consulta depois.
    @hash_molecular = Hash[]
...
#fun√ß√£o para ativar todas as pessoas
  ...
  #fun√ß√£o para desativar todas as pessoas que n„o fazem parte de algum cluster;
...
# Cria um arquivo contendo o grafo descrito em formato .net com matriz de adjacencia bipartida para ser usado no framework de Alex Santana
  def imprime_pajek_com_matriz_bipartiti(nome_arquivo, *args)
    ...
    # Esseshashs auxiliara mentendo uma lista de todos os elementos e suas respectivas posiÁıes na matriz de adjacencias
