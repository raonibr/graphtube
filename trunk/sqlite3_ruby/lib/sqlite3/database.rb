require 'sqlite3_ruby/lib/sqlite3/constants'
require 'sqlite3_ruby/lib/sqlite3/errors'
require 'sqlite3_ruby/lib/sqlite3/pragmas'
require 'sqlite3_ruby/lib/sqlite3/statement'
require 'sqlite3_ruby/lib/sqlite3/translator'
require 'sqlite3_ruby/lib/sqlite3/value'
  ...
  class Database
    ...
    def load_driver( driver )
      case driver
        ...
        when Symbol, String
          require "sqlite3_ruby/lib/sqlite3/driver/#{driver.to_s.downcase}/driver"
          driver = SQLite3::Driver.const_get( driver )::Driver
        else
          [ "Native", "DL" ].each do |d|
            begin
              require "sqlite3_ruby/lib/sqlite3/driver/#{d.downcase}/driver"
