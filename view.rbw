...
=begin
--------------------------------
View do programa em GTK, estágio primário

TO DO	
	- Refatorar
	- Comentar este código
...
LOCAL = 4
#++++++++++++++++++++++++++++++++++++++++++++++++++++++
#         FINAL DA DECLARAÇÃO DE CONSTANTES
#++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#------------------------TODAS AS CAIXAS RELACIONADAS A TRABALHO------------------------------#
	...
	check_end_trabalho = Gtk::CheckButton.new("Endereço")
...
#---------------------------TODAS AS CAIXAS RELACIONADAS A ESTUDO-----------------------------#
	...
	check_end_estudo = Gtk::CheckButton.new("Endereço")
...
#-----------------------------TODAS AS CAIXAS RELACIONADAS A LAZER----------------------------#
	...
	check_end_lazer = Gtk::CheckButton.new("Endereço")
